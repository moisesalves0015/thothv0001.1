        ...
        <div className="p-5 overflow-y-auto custom-scrollbar flex-1 min-h-0">
          ...
          <div className="mb-4">
            <textarea 
              ...
              className="w-full h-24 bg-transparent text-base text-slate-800 placeholder:text-slate-300 border-none focus:ring-0 resize-none p-0 custom-scrollbar"
              autoFocus
            />
          </div>
          ...
          <div className="flex items-center gap-2 px-3 py-2 bg-slate-50 rounded-xl border border-slate-100 mb-6 focus-within:border-[#006c55]/30 focus-within:bg-white transition-all">
            <span className="text-[#006c55] font-black text-sm select-none">#</span>
            <input 
              type="text" 
              value={hashtags}
              onChange={(e) => setHashtags(e.target.value)}
              placeholder="hashtags..."
              className="flex-1 bg-transparent border-none focus:ring-0 text-[12px] font-medium text-slate-600 placeholder:text-slate-300 p-0"
            />
          </div>
        </div>
